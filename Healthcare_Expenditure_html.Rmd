...
box_1 <- box_1 + guides(fill=guide_legend(title="Healthcare Expenditure by % of GDP"))
...
box_2 <- box_2 + guides(fill=guide_legend(title="Healthcare Expenditure by % of GDP"))
box_2
```

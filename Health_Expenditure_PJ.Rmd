...
box_1 <- ggplot(health_exp_deaths, aes(x = df_health_conf_categories, y = `Deaths per 100000`)) +
...
box_2 <- ggplot(health_exp_cases, aes(x = df_health_conf_categories, y = `Cases per 100000`)) +
  geom_boxplot(fill = colors) + 
